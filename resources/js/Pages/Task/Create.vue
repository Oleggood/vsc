<template>
    <task-main>
        <div class="flex justify-center">
            <h3 class="text-lg font-semibold">Создать задачу</h3>
        </div>

        <!--create-->
        <div class="flex justify-center mt-4">
            <form class="mt-4 w-full" @submit.prevent="store">
                <div class="">
                    <Link
                ...
                <div class="">
                    ...
                    <!--                    <InputLabel class="mt-2" for="new_task_users" value="Исполнители2:"/>-->
                    <!--                    <template>-->
                    <!--                        <div>-->
                    <!--                            <VueMultiselect-->
                    <!--                                v-model="formLocalCreate.users"-->
                    ...
                    <!--                    <select-->
                    <!--                        id="new_task_users"-->
                    <!--                        class="block border-gray-700 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"-->
                    <!--                        v-model="formLocalCreate.task_status_id"-->
                    <!--                    >-->
                    ...
                    <!--                    <InputLabel class="mt-2" for="new_task_task_status_id" value="Статус задачи:"/>-->
                    <!--                    <select-->
                    <!--                        id="new_task_task_status_id"-->
                    <!--                        class="block border-gray-700 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"-->
                    <!--                        v-model="formLocalCreate.task_status_id">-->
                    <!--                        <template v-for="status in statuses">-->
                    <!--                            <option :value="status.id">{{ status.status }}</option>-->
