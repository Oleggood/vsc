<template>
    <admin-main>
        ...
        <!--create-->
        <div class="max-w-[40%]">
            <form class="flex flex-col mt-8" @submit.prevent="store">
                <hr>
...
export default {
    ...
    methods: {
        store() {
            ...
            this.form.post('/admin/department', {
                onFinish: () => {
                    ...
                    this.formLocalCreate = {'id': '', 'department': '', 'note': ''};
                }
            });
        },

        showUpdateDialog(depart) {
            this.departmentTemp = depart.department;
            this.noteTemp = depart.note;
        ...
        hiddenUpdateDialog() {
            ...
            this.depart.department = this.departmentTemp;

            this.depart.note = this.noteTemp;
        },
