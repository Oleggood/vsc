<template>
    <admin-main>
        <div class="flex justify-center">
            <h3 class="text-lg font-semibold">Редактировать пользователя</h3>
        </div>

        <!--edit-->
        <div class="flex justify-center mt-4">
            <form class="mt-4" @submit.prevent="update(user)">
                <div class="">
                    <Link
                ...
                <div class="">
                    ...
                    <InputLabel class="mt-2" for="new_user_password" value="Пароль (оставьте пустым, чтобы не менять):"/>
                    <TextInput
...
export default {
    ...
    methods: {
        update(user) {
            ...
            this.form.patch(`/admin/user/${user.id}`, {
                onFinish: () => {
