                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('department.index')"
                                ...
                                <NavLink :href="route('crime.index')" :active="route().current('crime.*')">
                                    Статьи
                                </NavLink>
                                <NavLink :href="route('employer.index')" :active="route().current('employer.*')">
                                    Заказчики
                                </NavLink>
                        ...
                        <div class="flex">
                            <!-- Date, time -->
                            <div
                                class="hidden xl:flex items-center text-xs leading-4 font-light rounded-md text-gray-500">
                                {{ `${da} ${mo} ${ye} г.` }}
                            </div>
